...
abstract class SandwichBuilder {
	...
	public Sandwich1 getSandwich(){ return sandwich; }
	
	public void makeSandwich(){ sandwich = new Sandwich1(); }
...
class SandwichArtist {
	...
	public Sandwich1 getSandwich(){ return sandwichBuilder.getSandwich(); }
...
class TestBuilder{
	...
	public static void main(String[] args){
		...
		Sandwich1 bltSandwich = paul.getSandwich();
